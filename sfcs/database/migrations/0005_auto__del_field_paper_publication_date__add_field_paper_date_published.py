...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Paper.publication_date'
        db.delete_column('database_paper', 'publication_date')

        # Adding field 'Paper.date_published'
        db.add_column('database_paper', 'date_published', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Paper.publication_date'
        db.add_column('database_paper', 'publication_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 12, 22)), keep_default=False)

        # Deleting field 'Paper.date_published'
        db.delete_column('database_paper', 'date_published')
